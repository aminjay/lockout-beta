...
public class NotificationHelper {
     ...
     * @param context
     */
    public static void scheduleRepeatingRTCNotification(Context context, String time) {
...
//        String tempString2 = sharedPreferences.getString("notif_min", "10");
        ...
        Log.d("INTTEST:RAWSTRING",tempString);
        ...
        Log.d("LOGFINALBOOGIE",hours + "adsfasf" + mins);
        ...
        alarmManagerRTC.setExact(AlarmManager.RTC,calendar.getTimeInMillis(),alarmIntentRTC);
    }
